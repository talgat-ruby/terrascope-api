...
Wraps the slim inference fork in `core.vendor.sam_road`. Splits the raster
...
class SamRoadProcess:
    ...
    def _load(self) -> None:
        ...
        from core.vendor.sam_road.model import SAMRoad
...
def _infer_tile(
    ...
    from core.vendor.sam_road.infer_helpers import (
